...
export default function Home() {
  ...
  return (
    <>
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16">
        <RevealOnScroll>
          ...
          <p className="text-[var(--muted)] text-lg max-w-xl mb-8">
            A collection of projects built while learning to be a better
            engineer - from scrappy weekend builds to full capstone work.
          </p>
          <p className="text-[var(--muted)] text-lg max-w-xl mb-8">
            Currently pursuing a Bachelor’s degree in Software Engineering,
            driven by a strong passion for problem-solving and technology. My
            love for Mathematics led me to the field of Information Technology,
            where I am deeply engaged in Software Development. I am particularly
            excited about exploring Android and Web Development, constantly
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {projects.length === 0 && (
            <p className="text-[var(--muted)] col-span-full">
              No projects yet — run{" "}
              <code className="bg-[var(--card)] px-2 py-1 rounded">
                npm run new-project
              </code>{" "}
      ...
      <section
        id="contact"
        className="max-w-6xl mx-auto px-6 py-16 border-t border-[var(--border)]"
      >
        <RevealOnScroll>
